...
class UsersExportController extends BackendController
{
    ...
    {
        $this->resourceName = 'users_export';
        $this->model = new User();
    }
    ...
    public function store(Request $request)
    {
        ...
        $item = $this->model->create($request->except('password') + ['password' => bcrypt($request->input('password'))]);

        $roleExport = Role::where('name', 'export')->first();
        $item->attachRole($roleExport);
