...
@section('content')
    ...
    <p><a href="{{ route('admin.rates.create') }}" class="btn btn-success"><i class="material-icons">add_circle</i> Добавить</a></p>
            ...
            <tbody>
                @foreach($items as $item)
                    <tr>
                        ...
                        <td>{{ $item->rate }}</td>
                        <td>{{ $item->start_at }}</td>
                        <td><a href="{{ route('admin.rates.edit', $item->id) }}" class="btn btn-primary btn-small"><i class="material-icons">edit</i></a></td>
