...
@section('content')
    <h4 class="center">Курсы</h4>
    <p><a href="{{ route('admin.rates.create') }}" class="btn red waves-effect waves-light"><i class="material-icons left">add_circle</i> Добавить</a></p>
            ...
            <tbody>
                @foreach($items as $item)
                    <tr>
                        ...
                        <td>{{ $item->rate }}</td>
                        <td>{{ $item->start_at }}</td>
                        <td><a href="{{ route('admin.rates.edit', $item->id) }}" class="btn btn-small waves-effect waves-light"><i class="material-icons">edit</i></a></td>
